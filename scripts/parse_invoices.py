...
Usage: python scripts/parse_invoices.py [--limit 20] [--no-follow-links]

All the work lives in backend/process.py, which the API calls too. This file is
...
from backend.process import DEFAULT_LIMIT, Progress, ScanResult, scan_all  # noqa: E402
from backend.unipile import UnipileError  # noqa: E402
