...
from backend import invoice_store, invoices, share_mail, share_zip, shares
from backend.models import Share
from backend.services import api as api_module
...
def an_item(invoice_id: str, issued_on: str | None, **invoice) -> dict:
    """One row as backend.invoices hands it out: the payload, plus its two columns."""
